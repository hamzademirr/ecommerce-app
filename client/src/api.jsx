...
export const deleteProducts = async (products_id) => {
    const { data } = await axios.delete(`${process.env.REACT_APP_BASE_ENDPOINT}/product/${products_id}`);
    return data;
}

export const updateProducts = async (input, products_id) => {
    const { data } = await axios.put(`${process.env.REACT_APP_BASE_ENDPOINT}/product/${products_id}`, input);
    return data;
}
